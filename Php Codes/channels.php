...
echo "<h1><font color = \"#570044\"> <center> <u> Your Channel(s)</u> </center> </font> </h1>";
...
while($row = pg_fetch_row($func)){
	...
	//{
		...
		echo "<tr><td><p style = \"font-family:georgia,garamond,serif;font-size:24px;\"><a href = 'my_videos.php?id=$id'>$name</a></p></td></tr>";
		echo "<br/>";
...
echo "<button name= \"create_channel\" style = \"background:red;height:50px;width:200px;\"> <a href = \"create_channel.php\"> <font color = \"white\"> Create a new channel? </font> </a> </button>";
echo "</center>";
