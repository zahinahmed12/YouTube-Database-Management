...
$func = pg_query($db,"select * from likedvideos({$ans['user_id']})");
...
echo "<h1><font color = \"#FC0000\"> <center> <u> Liked Videos </u> </center> </font> </h1>";
echo "<table align = \"center\" bgcolor = \"#FFEBB6\">";
